...
public class Ventana extends JFrame {
	...
	public Ventana() {
		...
		String nombreDivisas[] = {"Dolares","Libras","Yen"};
		Float valorDivisas[]={1.25f,0.74f,129.87f};
		...
		for(int i=0;i<nombreDivisas.length;i++){
			despDivisas.addItem(nombreDivisas[i]);
		}
		...
		btnConvertir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(valorEuros<0 || valorEuros>500){
					...
					switch(divisa){
						case "Dolares":
							textResultado.setText(String.valueOf(valorEuros*valorDivisas[0]));
							textMensaje.setText("TODO OK");
							break;
						case "Libras":
							textResultado.setText(String.valueOf(valorEuros*valorDivisas[1]));
							textMensaje.setText("TODO OK");
							break;
						case "Yen":
							textResultado.setText(String.valueOf(valorEuros*valorDivisas[2]));
							textMensaje.setText("TODO OK");
							break;
					}
